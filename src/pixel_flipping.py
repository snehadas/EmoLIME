...
def get_explanation(audio, total_components, sr, predict_fn, num_samples=64, threshold=75,
    ...
    :param threshold: int, power threshold for loudness and ls decompositions, can be None for all others
    :param decomposition_type: "spectral", "temporal", "loudness", "ls" or "nmf": decomposition type for the audio
    ...
    if decomposition_type == 'temporal':
        ...
        print("Number of components ", decomposition.get_number_components())
